...
#     print("No Disabled topics found.")
# else:
...
#     filtered_df.to_excel('C:\\Users\\Gajendra\\Desktop\\disabled_summary.xlsx', index=False)
...
df = pd.read_excel("C:\\Users\\Gajendra\\Desktop\\disabled_summary.xlsx")
...
new_df.to_excel('C:\\Users\\Gajendra\\Desktop\\disabled.xlsx', index=False)