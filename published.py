...
# filtered_df = df[df['Status'] == 'Published']
...
#     filtered_df.to_excel('C:\\Users\\Gajendra\\Desktop\\published_summary.xlsx', index=False)
...
df = pd.read_excel("C:\\Users\\Gajendra\\Desktop\\published_summary.xlsx")
...
new_df.to_excel("C:\\Users\\Gajendra\\Desktop\\published.xlsx", index=False)
